...
## License
Need to sort that out still. Both the GPIO and the nanosecond timing code are GPLv3. However, I would like to release my portions as ISC. I probably need to bring the borrowed bits of code as external libraries to decouple the licenses.
